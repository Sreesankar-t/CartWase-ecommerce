...
const {adminhomepageget,adminhomepagepost,addproductsget,addproductspost,
       editProductget,editProductpost,unhideproductget,hideproductget,
       dashbordget,adminloginget,adminloginpost,adminlogoutget,userdataget,
       userdatapost,blockuserget, unblockuserget,categoryget,addcategoryget,
       addCategorypost,deleteCategoryget,editCategoryget,editCategorypost,
       hideCategoryget,unhideCategoryget,userOrderget,statuschangeget,userorderpost,
       bannerget,addbannerget,addbannerpost,AddBannerget,deletebannerget,
       viewCouponGet,addCouponGet,addCouponPost,editCouponGet,editCouponPost,
       deleteCouponPost,errorpageget,salesReport,salesReports,
...
router.post('/add-products',verifyLoginadmin,upload.array("Image", 4), addproductspost);

router.get('/edit-product/:id',verifyLoginadmin, editProductget);

router.post('/edit-product/:id',verifyLoginadmin,upload.array("Image", 4),editProductpost);
...
router.post('/add-category', verifyLoginadmin,upload.array("Image", 1),addCategorypost);

router.get('/delete-category/:id',deleteCategoryget);

router.get('/edit-category/:id',editCategoryget );

router.post('/edit-category/:id', verifyLoginadmin,upload.array("Image", 1), editCategorypost);
